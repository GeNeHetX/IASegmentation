...
def classNames =['Background', 'Tumor']   // names of classes of interest (simply add more values to list to add more classes)
double downsample = 1  // which downsampling level to use -> how much to downsample the patches
...
def pathOutput = buildFilePath(PROJECT_BASE_DIR, 'tiles2')
mkdirs(pathOutput)
println pathOutput
